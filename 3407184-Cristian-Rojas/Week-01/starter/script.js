...
console.log('=========================================');
console.log('Plataforma de Servicios de Traducción - FICHA DE PRESENTACIÓN');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       Servicios de Idiomas');
...
console.log('Valor calculado:    ', 50000 * 0.9); // Precio con 10% descuento
...
console.log('Estado booleano 1:  true'); // Activo

// TODO: Otro valor boolean diferente al anterior (true o false — sin comillas)
console.log('Estado booleano 2:  false'); // Premium
...
console.log('Dominio:          Plataforma de Servicios de Traducción');
...
console.log('¡Traduce el mundo con nuestros servicios profesionales!');
